...
String fString = /x:\documents\wffl\2018\stats-2018-d.csv/
...
List teams = ["PHI", "CHI", "LAC", "LAR", "SEA", "NOS",
              "DAL", "BAL", "KCC", "NEP", "IND", "HOU"]
...
fIn.eachLine()
{
   ...
   teams.each()
   {
      if (line.contains(it) || line.contains("---") || line.trim() == "")
	   {
	 		keep = true
      }
   }
