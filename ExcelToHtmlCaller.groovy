...
String excelFileIn = "x:\\Mapped\\WFFL\\2017.xlsx";
String htmlFile1 = "x:\\Mapped\\WFFL\\2017-orig.html";
String htmlFile2 = "x:\\Mapped\\WFFL\\2017.html";
String changesFileName = "x:\\Mapped\\WFFL\\2017-changes-MILLIS.txt";
...
void modifyHtml(String inFileName, String outFileName, def RECORD_CHANGES, def changesSet)
{
   String replaceThis = "<head>";
   String replaceWith = '<head><meta http-equiv="refresh" content="25"/><TITLE>2017 WFFL Auction</TITLE>'
   ...
   inFile.eachLine()
   {
      ...
      recordChanges(line, RECORD_CHANGES, changesSet)      
      outFile.append(line + "\n");
   }
}

void recordChanges(String line, def RECORD_CHANGES, def changesSet)
{
