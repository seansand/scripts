...
public final class IsJsonValid {
  ...
  {
     println IsJsonValid.isJsonValid("blert")
	 println IsJsonValid.isJsonValid('{"foo":"b;}')
     println IsJsonValid.isJsonValid("[]")
     println IsJsonValid.isJsonValid("{}")
     println IsJsonValid.isJsonValid('{"foo":"bar"} ')
	 println IsJsonValid.isJsonValid('{"foo":"} }')
